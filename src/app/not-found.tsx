    ...
    <MainLayout>
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            href="/"
            className="flex items-center justify-center gap-2 px-6 py-3 bg-accent hover:bg-accent-hover rounded-xl font-medium transition-colors"
          >
            <Home size={18} />
            Go Home
          </Link>
          <Link
            href="/channels"
            className="flex items-center justify-center gap-2 px-6 py-3 bg-background-secondary hover:bg-background-tertiary border border-border rounded-xl font-medium transition-colors"
          >
            <Search size={18} />
            Browse Channels
          </Link>
